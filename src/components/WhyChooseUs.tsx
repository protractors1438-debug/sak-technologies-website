...
export default function WhyChooseUs() {
  return (
    <section id="why-us" className="section-padding relative overflow-hidden bg-bg-secondary">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-radial-glow pointer-events-none opacity-40"></div>
        ...
        >
          {metrics.map((metric, index) => (
            ...
            >
              ...
              <div className="text-5xl md:text-6xl font-bold font-[family-name:var(--font-space-grotesk)] gradient-text mb-3 animate-pulse-glow" style={{ animationDuration: '4s' }}>
                <AnimatedCounter end={metric.value} suffix={metric.suffix} />
              </div>
              
              <div className="text-text-secondary text-xs md:text-sm uppercase tracking-wider font-semibold">
                {metric.label}
              </div>
            </motion.div>
          ))}
