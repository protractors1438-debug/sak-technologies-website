        ...
        >
          ...
          <div className="absolute inset-2 rounded-xl overflow-hidden bg-bg-primary border border-white/10 group">
            ...
            <div className="absolute inset-0 w-full h-full">
              ...
              />
              {/* Overlay Gradient */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#030014] via-[#030014]/60 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300"></div>
            </div>
            ...
            >
              ...
              <h3 className="text-2xl md:text-3xl font-bold font-[family-name:var(--font-outfit)] text-white mb-2 group-hover:text-accent-blue transition-colors">
                {item.title}
              </h3>
              
              {/* Hover indicator */}
              {item.link !== "#" && (
                <div className="flex items-center gap-2 text-sm text-text-tertiary opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-4 group-hover:translate-y-0 transform">
            ...
            <div 
              ...
              style={{
                ...
                background: `radial-gradient(circle at ${rotation.y * 10 + 50}% ${rotation.x * 10 + 50}%, rgba(255,255,255,0.2) 0%, transparent 50%)`
              }}
            ></div>
          </div>
        </div>
