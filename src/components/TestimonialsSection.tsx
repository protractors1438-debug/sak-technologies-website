...
const testimonials = [
  ...
  {
    quote: "From concept to launch, SAK Technologies demonstrated exceptional professionalism and creativity.",
    author: "Priya Sharma",
    role: "Director",
...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="section-padding relative overflow-hidden bg-bg-secondary">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-radial-glow-purple pointer-events-none opacity-40"></div>
              ...
              {visibleTestimonials.map((testimonial, idx) => (
                ...
                >
                  <div className="glass-card rounded-3xl p-8 h-full flex flex-col relative group">
                    {/* Floating quote mark */}
                    <div className="absolute top-6 right-8 text-6xl text-white/5 font-serif leading-none group-hover:text-accent-purple/20 transition-colors duration-500">
                      "
                    </div>
                    ...
                    <p className="text-lg italic text-text-secondary leading-relaxed mb-8 flex-grow">
                      "{testimonial.quote}"
                    </p>
                    ...
                    <div className="flex items-center gap-4 mt-auto">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-tertiary">{testimonial.role}, {testimonial.company}</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
