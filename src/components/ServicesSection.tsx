...
export default function ServicesSection() {
  return (
    <section id="services" className="section-padding relative overflow-hidden bg-bg-primary">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-radial-glow-purple pointer-events-none"></div>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-accent-blue to-accent-purple opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              ...
              <h3 className="text-xl font-semibold mb-3 font-[family-name:var(--font-outfit)] group-hover:text-accent-blue transition-colors">
                {service.title}
              </h3>
